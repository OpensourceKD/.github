...
<!-- Copy this file to .github/copilot-instructions.md in your member repo.
     It ensures the Copilot Coding Agent always sees the org-wide standards,
     even before the governance workflow posts its full prompt comment. -->
